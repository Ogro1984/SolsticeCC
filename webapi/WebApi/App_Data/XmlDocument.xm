...
<doc>
    ...
    <members>
        ...
        <member name="T:WebApi.Controllers.ContactController">
            <summary>
            general api controller
            <param name="id">es la boya que anda flotando</param>
            </summary>
        </member>
        <member name="M:WebApi.Controllers.ContactController.Post">
            <summary>
            puto babosoooo
            </summary>
            <returns></returns>
